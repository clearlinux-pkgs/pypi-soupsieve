...
Source0  : https://files.pythonhosted.org/packages/3e/db/5ba900920642414333bdc3cb397075381d63eafc7e75c2373bbc560a9fa1/soupsieve-2.0.1.tar.gz
...
%prep
%setup -q -n soupsieve-2.0.1
cd %{_builddir}/soupsieve-2.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589858964
...
cp %{_builddir}/soupsieve-2.0.1/LICENSE.md %{buildroot}/usr/share/package-licenses/soupsieve/bb9c4f272c1b7a041df0ca4dff99588d6ad958c8
cp %{_builddir}/soupsieve-2.0.1/docs/src/markdown/about/license.md %{buildroot}/usr/share/package-licenses/soupsieve/aed22c356adf0d9eddf6a06b96e4672094334f1d
